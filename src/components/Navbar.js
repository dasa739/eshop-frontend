...
import {MdAddShoppingCart, MdPersonAddAlt} from 'react-icons/md'
...
<NavBar>
    <Container>
       ...
       <Nav>
           {isLogedIn?
           <>
                <MdAddShoppingCart style={iconCursor} onClick={() => navigate('/carts')} className='me-3'/>
                <MdPersonAddAlt style={iconCursor} onClick={() => navigate('/profile')}/>
                </>  
                :
            <>
